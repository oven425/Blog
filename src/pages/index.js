...
//           return (
//             <div key={index}>{`name:${item.node.name} id:${item.node.id}`}</div>
//           )
//         })
//       }
...
// const IndexPage = () => {
//   const [mds, allfiles] = useAllMarkdownRemark();
//   //const { edges } = useAllFile()
//   return (
//     <div>
//       <div>markdown</div>
//       <div>{JSON.stringify(mds)}</div>
//       {
//         mds.edges.map((item, index) => {
//           return (
//             <div key={index}>{item.node.id}</div>
//           )
//         })
//       }
//       <div>files</div>
//       <div>{JSON.stringify(allfiles)}</div>
//       {
//         allfiles.edges.map((item, index) => {
//           return (
//             <div key={index}>{item.node.id}</div>
//           )
//         })
...
//   return (
//     <div>
//       <div>{JSON.stringify(data.allFile)}</div>
//       {
